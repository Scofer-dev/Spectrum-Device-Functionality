...
private ["_module","_signalReceivers","_receiverObject","_objectSelect","_objectVar","_endAction","_range","_frequency","_delay","_sourceSeen","_minFreq","_maxFreq","_freqCheck","_arrayIndex","_strength","_arrayFrequency","_arrayStrength","_signalName","_signalActivation"];
...
//===============Waits until the spectrum receiver is defined, used primarily for multiplayer with One Device mode, where it can start undefined===============
...
if (receiverMethod == 2) exitWith
{
	...
	{
		_receiverObject = missionNamespace getVariable [_x, objNull];
		hint format ["ReceiverObject: %1",_receiverObject];
		sleep 5;
		private "_clientID";
		_clientID = owner _receiverObject;
		hint format ["ClientID: %1",_clientID];
		sleep 5;
